...
> **v1.2.4** — 17 bug fixes: spinner, input wrap, cost tracking, session reset, Google tool result, remember persist + more
...
3. Run the installer:
   ```bash
   chmod +x install-sgr-1.2.4.sh
   ./install-sgr-1.2.4.sh
   ```
